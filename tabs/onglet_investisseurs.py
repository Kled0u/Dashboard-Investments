...
def display_tab(df_perf_net, df_apports):
    ...
    if selected_investor:
        ...
        col2.metric("Valeur Nette Estimée", format_eur(valeur_nette), help="Valeur brute après déduction des frais et impôts latents.")
        
        # --- LIGNE MODIFIÉE ---
        col3.metric("Gain/Perte Net Final", format_eur(gain_net), delta_color="normal")
        # --------------------
